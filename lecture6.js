...
const trainingData = [];
// now we are going to iterate over brightnesses and colors
// to build up our training data;

for (let i = 0; i < colors.length; i++) {
	//Each of our training set are an object
	trainingData.push({
		input: colors[i],
...
// bonus
// what if we had to converte our problem? What if we were asking
// the neural net for color, rather than classfying by brightness;
